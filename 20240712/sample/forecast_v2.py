...
def show_forecast(product,start_datetime,selected_zaiko):
    ...
    #file_path = '中間成果物/在庫推移MBデータ_統合済&特定日時抽出済.csv'#こっちは文字化けでエラーになる
    ...
    Timestamp_df = Timestamp_df[Timestamp_df['品番'] == product]
