...
def display_shap_contributions(df1_long):
    ...
    def map_factor_positive(variable):
        ...
        #!new 
            ...
            return "「正常な入庫かんばん数が多い」"
        elif variable.startswith("No13_"):
            return "「西尾東BC or 部品置き場で滞留しているかんばん数が少ない」"
        elif variable.startswith("No14_"):
            return "「異常な入庫かんばん数が多い（Ex：部品置き場で滞留していたモノの入庫）」"
    ...
    def map_factor_negative(variable):
        ...
        #!new 
            ...
            return "「正常な入庫かんばん数が少ない」"
        elif variable.startswith("No13_"):
            return "「西尾東BC or 部品置き場で滞留しているかんばん数が多い」"
        elif variable.startswith("No14_"):
            return "「異常な入庫かんばん数が少ない（Ex：部品置き場で滞留していたモノの入庫）」"
        elif variable.startswith("No15_"):
            return "「投入間口が一杯で入庫できない」"
        elif variable.startswith("No16_"):
